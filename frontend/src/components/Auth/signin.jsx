...
const SigninPage = () => {
  ...
  const { login } = useContext(AuthContext) // Access signup from AuthContext
  ...
  return (
    <>
      <section className="relative z-10 overflow-hidden pb-20 pt-40 md:pb-20 lg:pb-28 lg:pt-[180px] ">
